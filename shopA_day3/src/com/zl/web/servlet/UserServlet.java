...
public class UserServlet extends BaseServlet {
	...
	public void register(HttpServletRequest request, HttpServletResponse response)
		...
		if (isRegisterSuccess) {
			// 发送激活邮件
			String emailMsg = "恭喜您注册成功，请点击下面的连接进行激活账户" + "<a href='http://localhost:8080/shopA/active?activeCode="
					+ activeCode + "'>" + "http://localhost:8080/shopA/active?activeCode=" + activeCode + "</a>";
			try {
